...
const CORPUS_STATS = [
  { label: "Total papers", value: "10,230" },
  { label: "APSA 2026", value: "5,493" },
  { label: "ICA 2026", value: "3,413" },
  { label: "EPSS 2026", value: "1,324" },
];
    ...
    <div className="analysis-page">
      ...
      <section className="analysis-hero" aria-labelledby="analysis-title" data-reveal>
        <div className="hero-copy">
          <div className="corpus-kicker anim-fade-up">
            ...
            <span className="font-mono tabnum"><CountUp value={10230} /> papers indexed</span>
            <span className="kicker-divider" />
            <span>APSA 2026 · ICA 2026 · EPSS 2026</span>
          </div>
          ...
          <p className="hero-subtitle anim-fade-up d200">
            {lang === "en"
              ? "Compare your question with 10,230 conference papers, then turn the closest evidence into a defensible next step."
              : "将研究问题与 10,230 篇最新会议论文进行比对，再把最接近的证据转化为站得住的研究方向。"}
          </p>
        </div>
        ...
        <aside className="evidence-radar anim-fade-up d200" aria-label="Live evidence network">
          ...
          <div className="radar-center">
            <strong className="font-mono tabnum"><CountUp value={10230} /></strong>
      ...
      <section className="corpus-overview" aria-labelledby="corpus-title">
        <div className="section-heading" data-reveal>
          ...
          <p>Live coverage across three 2026 social-science conferences.</p>
        </div>
